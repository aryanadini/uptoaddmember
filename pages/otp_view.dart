    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
              ...
              title: Text("OTP Verification",style: TextStyle(color:Color(0xFFFFFFFF),fontSize: 22,
          ...
          children: [
              ...
              Align(
                ...
                child: Text("Enter the OTP code sent to your registered mobile number.",
                        ...
                        fontSize: 16,color: Color(0xFFFFFFFF),height: 1.38
                  ),
           ...
           Column(mainAxisAlignment: MainAxisAlignment.center,
                   ...
                   children: [
                     TextSpan(
                      ...
                      TextSpan(
                                ...
                                style: TextStyle(
                                fontFamily: 'Figtree',fontWeight: FontWeight.w400,
                                fontSize: 16,color: Color(0xFFF7B52C)
                           ),
               ...
               Container(
                 ...
                 child: Text('Verify',style: TextStyle(fontFamily: 'Figtree',
                        fontWeight: FontWeight.w600,fontSize: 16,color: Color(0xFF1E1E1E)),),
